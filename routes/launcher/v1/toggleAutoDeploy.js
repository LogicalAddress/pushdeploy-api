...
deleteWebHook = require("../../../lib/launcher/updateGitWebHooks.js");

module.exports = function (app, socketIO) {
	app.post('/v1/app/toggle_auto_deploy', Auth, refreshToken, Cred, getApp, (req, res, next) => {
		if(req.techpool.app.auto_deploy){
			deleteWebHook(req.techpool.app, req.techpool.credentials)
			.then((response)=>{
				req.techpool.app.auto_deploy = !req.techpool.app.auto_deploy;
				req.techpool.app.webhook_sub_id = null;
