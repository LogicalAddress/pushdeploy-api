...
var config = {
  development: {
    NameServer: {
      END_POINT: process.env.DNS_API || "http://dnsapi.pushdeploy.xyz/atomiadns.json",
      ADMIN_USER: process.env.DNS_ADMIN_USER || "support@pushdeploy.io",
      ADMIN_PASS: process.env.DNS_ADMIN_PASS || "faker00tX",
      DEFAULT_SOA_VALUES: process.env.DNS_DEFAUL_SOA_VALUES ? process.env.DNS_DEFAUL_SOA_VALUES.split(",") : [ 1800, 'pushdeploy.xyz.', "hostmaster.pushdeploy.xyz", 10800, 3600, 604800, 86400 ],
      DEFAULT_NAMESERVERS: process.env.DEFAULT_NAMESERVERS ? process.env.DEFAULT_NAMESERVERS.split(",") : 'ns1.pushdeploy.xyz.,ns2.pushdeploy.xyz.,ns3.pushdeploy.xyz.'.split(","),
