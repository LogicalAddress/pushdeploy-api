...
var config = {
  development: {
    ...
    ClientSetting: {
      ...
      stripePlanA: process.env.STRIPE_PLAN_A || 'price_1GsYO7BCbNSslgzUgUg19KLp',
      ...
      stripePlanB: process.env.STRIPE_PLAN_B || 'price_1GsYPfBCbNSslgzUl17jVKeX',
  ...
  production: {
    ...
    ClientSetting: {
      stripeKey: process.env.STRIPE_PUBLIC_KEY,
      paystackKey: process.env.PAYSTACK_PUBLIC_KEY,
      stripePlanA: process.env.STRIPE_PLAN_A,
      stripePlanADesc: 'Deploy Test $9.99/Month',
      stripePlanAA: process.env.STRIPE_PLAN_AA,
      stripePlanAADesc: 'Deploy Test $99.90/Year',
      stripePlanB: process.env.STRIPE_PLAN_B,
      stripePlanBDesc: 'Deploy Pro $19.99/Month',
      stripePlanBB: process.env.STRIPE_PLAN_BB,
      stripePlanBBDesc: 'Deploy Pro $199.90/Year',
      stripePlanAAmount: '999',
      stripePlanAAAmount: '9990',
      stripePlanBAmount: '1999',
