...
module.exports = function(req, _server){
	...
	try{
		...
		opts.session = [
	        ...
	        { op: 'exec', command: 'export SERVER_ID='+_server._id+' CALLBACK_TOKEN='+req.techpool.user.access_token+' CALLBACK_URL='+AppConfig.AppDomain+'/v1/server/events ACTION=server_logs && /home/'+_server.superuser+'/.setup.sh > .query.log.out 2>&1' },
	    ];
		...
		console.log("Exception Thrown at serverLogs.js", error);
	}
};