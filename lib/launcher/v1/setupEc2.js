	...
	return new Promise(function(resolve, reject) {
		// try{
			...
			opts.session = [
		        ...
		        { op: 'exec', command: 'export SERVER_ID='+_server._id+' CALLBACK_URL='+AppConfig.AppDomain+'/v1/events ACTION=init_with_default_app SERVER_ENTRY_POINT='+copts.entry_point+' APP_NAME=default PORT=3000 TEMPLATE=nodejs NODE_VERSION='+copts.node_version+' REPOSITORY="'+copts.example_repo+'" && /home/'+opts.username+'/.setup.sh > log.out 2>&1' },
		    ];
