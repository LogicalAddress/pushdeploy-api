		...
		(err, res, body) => {
    		...
    		if(body){
    			return resolve({
    				status: "success",
    				data: {
    					DomainName: body['interface-response']['DomainName'],
    					message: body['interface-response']['RRPText'],
    					provider: body['interface-response']['Site'],
    					IsLockable: body['interface-response']['IsLockable'],
    					IsRealTimeTLD: body['interface-response']['IsRealTimeTLD'],
    				}
    			});		
    		}else{
