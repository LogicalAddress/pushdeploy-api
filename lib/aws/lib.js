...
Aws.prototype.instances = function(payload){
	...
	return new Promise(function(resolve, reject) {
		...
		resolve([
			{
				name: "t1.micro",
				description: "1 Gig RAM, Single Core CPU"
			},{
				name: "t2.nano",
				description: "2 Gig RAM, 2 Core CPU"
			},
			{
				name: "t2.micro",
				...
				name: "t2.xlarge",
				description: "t2.xlarge",
			},{
				name: "t2.2xlarge",
				description: "t2.2xlarge",
			},{
				name: "m1.small",
				description: "m1.small",
			},{
				name: "m1.medium",
				description: "m1.medium",
			},{
				name: "m1.large",
				description: "m1.large",
			},{
				name: "m1.xlarge",
				description: "m1.xlarge",
			},{
				name: "m3.medium",
				description: "m3.medium",
			}
		]);
	});
};
